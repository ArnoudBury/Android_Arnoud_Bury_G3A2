...
import com.example.countryapplication.ui.countryRank.density.CountryRankDensityApiState
import com.example.countryapplication.ui.countryRank.density.CountryRankDensityListState
import com.example.countryapplication.ui.countryRank.density.CountryRankDensityViewModel
...
/**
 * Test suite for [CountryRankDensityViewModel] responsible for handling country density rank related data and UI states.
 */
@ExperimentalCoroutinesApi
class CountryRankDensityViewModelTest {

    private lateinit var viewModel: CountryRankDensityViewModel
    ...
    /**
     * Test to verify that 'getApiCountriesRankedDensity' updates UI list state and sets 'countryApiState' to Success.
     */
    @Test
    fun `getApiCountriesRankedDensity should update uiListState and set countryApiState to Success`() =
        testScope.runTest {
            // Arrange
            ...
            viewModel = CountryRankDensityViewModel(countryRepository)

            // Act
            viewModel.getApiCountriesRankedDensity()

            val collectCompleted = CompletableDeferred<Unit>()

            // Act
            var uiListCountryState: CountryRankDensityListState? = null
            val job = launch {
            ...
            // Assert
            assert(viewModel.countryApiState is CountryRankDensityApiState.Success)
            assert(uiListCountryState == CountryRankDensityListState(getMockCountries()))
