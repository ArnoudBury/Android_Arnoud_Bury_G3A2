...
import com.example.countryapplication.ui.countryRank.population.CountryRankPopulationApiState
import com.example.countryapplication.ui.countryRank.population.CountryRankPopulationListState
import com.example.countryapplication.ui.countryRank.population.CountryRankPopulationViewModel
...
/**
 * Test suite for [CountryRankPopulationViewModel] responsible for handling country population rank related data and UI states.
 */
@ExperimentalCoroutinesApi
class CountryRankPopulationViewModelTest {

    private lateinit var viewModel: CountryRankPopulationViewModel
    ...
    /**
     * Test to verify that 'getApiCountriesRankedPopulation' updates UI list state and sets 'countryApiState' to Success.
     */
    @Test
    fun `getApiCountriesRankedPopulation should update uiListState and set countryApiState to Success`() =
        testScope.runTest {
            // Arrange
            ...
            viewModel = CountryRankPopulationViewModel(countryRepository)

            // Act
            viewModel.getApiCountriesRankedPopulation()

            val collectCompleted = CompletableDeferred<Unit>()

            // Act
            var uiListCountryState: CountryRankPopulationListState? = null
            val job = launch {
            ...
            // Assert
            assert(viewModel.countryApiState is CountryRankPopulationApiState.Success)
            assert(uiListCountryState == CountryRankPopulationListState(getMockCountries()))
